...
def get_default_args():
    ...
    parser.add_argument('--gen_max_len', type=float, default=128)
    ...
    parser.add_argument('--gen_sampling_temperature', type=float, default=2.)
    ...
    parser.add_argument('--nu_file', type=str, default='lib/models/oracle_models/svr_model_nu.joblib')
    ...
    parser.add_argument('--residues_file', type=str, default='lib/data/residues.csv')
